...
export function ExampleSection() {
  return (
    <div className="prose prose-lg max-w-none">
      ...
      <h2 className="text-2xl md:text-3xl italic mb-6 mt-8 text-primary">
      ...
      {/* Blockquote example */}
      <blockquote className="border-l-2 pl-6 italic text-muted my-8" style={{ borderColor: 'rgba(140,106,62,0.3)' }}>
      ...
      <ul className="list-disc list-inside text-primary space-y-2 mb-6 ml-4">
